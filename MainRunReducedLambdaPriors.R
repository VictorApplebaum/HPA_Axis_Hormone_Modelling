...
model <- stan_model('ModelReducedLambdaPriors.stan')
...
save(samps,file='FitReducedLambdaPriors.RData')
...
# Save both
ggsave("HeatPlot_JeffreysReducedLambdaPriors.png", p1, width = 10, height = 8)
ggsave("HeatPlot_NumericPORReducedLambdaPriors.png", p2, width = 10, height = 8)
...
ggsave("CredibleIntervalsReducedLambdaPriors.png", p_ci_text, width = 10, height = 8)
